...
[![Tests](https://img.shields.io/badge/tests-349%20passing-2ea44f)](https://github.com/heggria/Hermit/actions/workflows/ci.yml)
...
- CI：GitHub Actions 在 Ubuntu / macOS 上跑主测试矩阵
- 测试：本地 `uv run pytest -q` 通过，当前结果为 `349 passed`（2026-03-11）
- 依赖：Python 与 GitHub Actions 依赖由 Dependabot 每周检查
- Lint：仓库还有一批历史 Ruff 问题，当前未作为强制门禁；新增改动应保持增量整洁
