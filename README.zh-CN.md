...
<p align="center">
  <img src="./docs/site/assets/hermit-macos-icon.svg" alt="Hermit macOS 菜单栏图标" width="96" height="96">
</p>
...
![普通 agent 与 Hermit 的对照](./docs/site/assets/png/hermit-vs-generic-agent-zh-cn.png)
...
![Hermit 的受治理执行路径](./docs/site/assets/png/hermit-governed-path-zh-cn.png)

## 为什么会有这种手感

![Hermit 的核心差异](./docs/site/assets/png/hermit-differentiators-zh-cn.png)
...
![Hermit 架构总览](./docs/site/assets/png/hermit-architecture-overview-zh-cn.png)
