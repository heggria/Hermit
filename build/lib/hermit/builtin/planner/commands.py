...
def _cmd_plan(runner: Any, session_id: str, text: str) -> Any:
    ...
    if subcommand == "confirm":
        return runner._dispatch_control_action(session_id, action="plan_confirm", target_id="")
    if subcommand == "off":
        return runner._dispatch_control_action(session_id, action="plan_exit", target_id="")
    return runner._dispatch_control_action(session_id, action="plan_enter", target_id="")
