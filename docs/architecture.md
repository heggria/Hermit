...
主入口在 [`hermit/main.py`](/Users/beta/work/Hermit/hermit/main.py)。
...
[`AgentRunner`](/Users/beta/work/Hermit/hermit/core/runner.py) 是统一调度层。
...
[`ClaudeAgent`](/Users/beta/work/Hermit/hermit/core/agent.py) 实现手写 Anthropic Messages API tool loop。
...
### [`hermit/core/agent.py`](/Users/beta/work/Hermit/hermit/core/agent.py)

- Anthropic 调用与 block 规范化
- tool loop
- usage 统计

### [`hermit/core/runner.py`](/Users/beta/work/Hermit/hermit/core/runner.py)
...
### [`hermit/core/session.py`](/Users/beta/work/Hermit/hermit/core/session.py)

- session 使用单个 JSON 文件持久化
- 空闲超时后归档到 `sessions/archive/`
- 当前不是 JSONL

### [`hermit/core/tools.py`](/Users/beta/work/Hermit/hermit/core/tools.py)
...
### [`hermit/plugin/manager.py`](/Users/beta/work/Hermit/hermit/plugin/manager.py)
...
### [`hermit/plugin/loader.py`](/Users/beta/work/Hermit/hermit/plugin/loader.py)

- 解析 `plugin.toml`
- 根据 `[entry]` 中的 `module:function` 调用插件入口
- builtin 插件通过 `hermit.builtin.<dir>.<module>` 导入

### [`hermit/storage/`](/Users/beta/work/Hermit/hermit/storage)

- [`atomic.py`](/Users/beta/work/Hermit/hermit/storage/atomic.py): 原子写
- [`lock.py`](/Users/beta/work/Hermit/hermit/storage/lock.py): `FileGuard`
- [`store.py`](/Users/beta/work/Hermit/hermit/storage/store.py): `JsonStore`
