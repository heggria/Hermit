...
description: Generate or update Hermit's README launch diagrams and docs hero visuals using Excalidraw scene JSON plus GitHub-safe SVG and PNG exports. Use when editing `docs/site/assets/*.excalidraw.json`, tightening README visual layout, or regenerating PNGs for GitHub rendering.
---
...
- `docs/site/assets/hermit-differentiators.excalidraw.json`
- `docs/site/assets/hermit-differentiators-zh-cn.excalidraw.json`
- `docs/site/assets/hermit-governed-path.excalidraw.json`
- `docs/site/assets/hermit-governed-path-zh-cn.excalidraw.json`
- `docs/site/assets/hermit-architecture-overview.excalidraw.json`
- `docs/site/assets/hermit-architecture-overview-zh-cn.excalidraw.json`
- `docs/site/assets/hermit-vs-generic-agent.excalidraw.json`
- `docs/site/assets/hermit-vs-generic-agent-zh-cn.excalidraw.json`
- `docs/site/assets/png/*.png`
- `README.md`
- `README.zh-CN.md`
...
python3 scripts/generate_excalidraw_readme_assets.py
sips -g pixelWidth -g pixelHeight docs/site/assets/png/hermit-differentiators.png docs/site/assets/png/hermit-governed-path.png docs/site/assets/png/hermit-architecture-overview.png
```

If you need a visual pass, open the PNGs directly from:

- `docs/site/assets/png/hermit-differentiators.png`
- `docs/site/assets/png/hermit-governed-path.png`
- `docs/site/assets/png/hermit-architecture-overview.png`
