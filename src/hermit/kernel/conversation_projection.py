...
from hermit.kernel.store_support import canonical_json as _canonical_json
from hermit.kernel.store_support import sha256_hex as _sha256_hex
...
class ConversationProjectionService:
    ...
    def _build_payload(self, conversation_id: str) -> dict[str, Any]:
        ...
        for ingress in self.store.list_ingresses(conversation_id=conversation_id, limit=50):
            ...
            resolution_counts: dict[str, int] = dict(ingress_metrics.get("resolution_counts") or {})
