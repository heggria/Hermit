...
class ApprovalCopyService:
    ...
    def _sections_from_mapping(self, raw_sections: Any) -> tuple[ApprovalSection, ...]:
        ...
        for raw_section_entry in cast(list[Any], raw_sections):
            if not isinstance(raw_section_entry, dict):
                continue
            raw_section = cast(dict[str, Any], raw_section_entry)
    ...
    def _facts(
        ...
        return {
            ...
            "tool_name": tool_name,
            "tool_input": dict(cast(dict[str, Any], tool_input))
    ...
    def _scheduler_input(self, facts: dict[str, Any]) -> dict[str, Any]:
        ...
        return dict(cast(dict[str, Any], tool_input)) if isinstance(tool_input, dict) else {}
