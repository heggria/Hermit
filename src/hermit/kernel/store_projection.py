...
from hermit.kernel.store_support import json_loads
from hermit.kernel.store_types import KernelStoreTypingBase


class KernelProjectionStoreMixin(KernelStoreTypingBase):
    def build_task_projection(self, task_id: str) -> dict[str, Any]:
        ...
        entity_maps = {
            ...
            "execution_contract": projection["execution_contracts"],
            "evidence_case": projection["evidence_cases"],
            "authorization_plan": projection["authorization_plans"],
            "reconciliation": projection["reconciliations"],
