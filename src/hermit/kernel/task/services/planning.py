    ...
    def state_for_task(self, task_id: str) -> PlanningState:
        ...
        for event in self.store.list_events(task_id=task_id, limit=500):
            ...
            if event_type == "planning.entered":
                ...
                and str(payload.get("decision_type", "")) == "planning"
            ):
                state.latest_planning_decision_id = (
                    str(event.get("entity_id", "") or "") or state.latest_planning_decision_id
                )
        ...
        *,
        ...
        self.store.append_event(
            ...
            payload={
                ...
                "step_id": ctx.step_id,
                "candidate_plan_refs": list(self.state_for_task(ctx.task_id).candidate_plan_refs)
