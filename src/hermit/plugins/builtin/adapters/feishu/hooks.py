...
from hermit.plugins.builtin.adapters.feishu.adapter import get_active_adapter
from hermit.plugins.builtin.adapters.feishu.reaction import add_reaction, resolve_emoji_type
from hermit.plugins.builtin.adapters.feishu.tools import register_tools
...
def _on_post_run(
    ...
    **_: Any,
    ...
    if adapter is None:
        return
    try:
        adapter.handle_post_run_result(result, session_id=session_id, runner=runner)
    except Exception:
