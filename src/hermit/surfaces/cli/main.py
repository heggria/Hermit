...
from hermit.runtime.assembly.context import build_base_context, ensure_default_context_file
...
def _on_tool_call(name: str, inputs: dict[str, Any], result: object) -> None:
