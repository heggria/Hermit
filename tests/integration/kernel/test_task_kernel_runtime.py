...
def test_builtin_tool_metadata_audit_marks_reads_and_writes_explicitly(tmp_path: Path) -> None:
    from hermit.plugins.builtin.adapters.feishu.hooks import register as register_feishu_hooks
    from hermit.plugins.builtin.hooks.image_memory.hooks import register as register_image_memory
    from hermit.plugins.builtin.hooks.scheduler.tools import register as register_scheduler
    from hermit.plugins.builtin.hooks.webhook.tools import register as register_webhook
    from hermit.plugins.builtin.tools.computer_use.tools import register as register_computer
    from hermit.plugins.builtin.tools.grok.tools import register as register_grok
    from hermit.plugins.builtin.tools.web_tools.tools import register as register_web_tools
