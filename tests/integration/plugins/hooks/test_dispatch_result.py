...
class TestFeishuDispatchResultHandler:
    def _make_handler(self):
        from hermit.plugins.builtin.adapters.feishu.hooks import _on_dispatch_result
    ...
    def test_sends_to_feishu_chat_id(self) -> None:
        ...
        with (
            patch("hermit.plugins.builtin.adapters.feishu.hooks.build_lark_client") as mock_client,
            patch(
                "hermit.plugins.builtin.adapters.feishu.reply.should_use_card", return_value=False
            ),
            patch(
    ...
    def test_missing_message_id_marks_delivery_failure(self) -> None:
        ...
        with (
            ...
            patch(
                "hermit.plugins.builtin.adapters.feishu.reply.send_text_message", return_value=None
            ) as mock_send,
        ):
            mock_client.return_value = MagicMock()
            result = handler(
