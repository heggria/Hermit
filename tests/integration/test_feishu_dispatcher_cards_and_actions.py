...
def test_feishu_adapter_scheduler_read_skill_sends_get_before_schedule_mutation(
    ...
    monkeypatch.setattr(
        "hermit.plugins.builtin.adapters.feishu.adapter.add_reaction",
...
def test_feishu_adapter_card_action_submits_approval_job(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "hermit.plugins.builtin.adapters.feishu.adapter.build_thinking_card",
...
def test_feishu_adapter_approval_action_resume_uses_task_conversation(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "hermit.plugins.builtin.adapters.feishu.adapter.patch_card", lambda *_a, **_kw: True
    )
