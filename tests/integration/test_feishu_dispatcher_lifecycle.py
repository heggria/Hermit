...
def test_feishu_adapter_receive_loop_treats_normal_close_as_graceful(monkeypatch) -> None:
    import hermit.plugins.builtin.adapters.feishu.adapter as adapter_module
    from hermit.plugins.builtin.adapters.feishu.adapter import FeishuAdapter
    ...
    monkeypatch.setattr(
        "hermit.plugins.builtin.adapters.feishu.adapter.log.info",
        lambda message: info_logs.append(message),
    )
