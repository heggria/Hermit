...
from hermit.infra.system.i18n import (
    catalog_locales,
    load_catalog,
    localize_schema,
    normalize_locale,
...
from hermit.plugins.builtin.adapters.feishu.tools import _all_tools as all_feishu_tools
...
def test_normalize_locale_aliases() -> None:
    assert normalize_locale(["zh_CN", "UTF-8"][0]) == "zh-CN"
...
def test_load_catalog_merges_single_file_and_directory(monkeypatch, tmp_path: Path) -> None:
    import hermit.infra.system.i18n as i18n_mod
